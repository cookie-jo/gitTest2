        ...
        <div class="row mb-5">
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="media-image">
              <a href="single.html"><img src="images/product_1.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
                <h2 class="font-secondary text-uppercase"><a href="single.html">홍차</a></h2>
                <span class="d-block mb-3">7,900원</span>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="media-image">
              <a href="single.html"><img src="images/product_2.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
                <h2 class="font-secondary text-uppercase"><a href="single.html">감잎차</a></h2>
                <span class="d-block mb-3">7,900원</span>
                <p>감잎차는 비타민C가 풍부한 차로 감기예방에 탁월합니다. 특히 환절기에 마시면 아주 좋습니다.</p>
                <p><a href="#">더 보기</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="media-image">
              <a href="single.html"><img src="images/product_3.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
                <h2 class="font-secondary text-uppercase"><a href="single.html">동백차</a></h2>
                <span class="d-block mb-3">7,900원</span>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="media-image">
              <a href="single.html"><img src="images/product_4.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
                <h2 class="font-secondary text-uppercase"><a href="single.html">결명자차</a></h2>
                <span class="d-block mb-3">7,900원</span>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="media-image">
              <a href="single.html"><img src="images/product_5.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
                <h2 class="font-secondary text-uppercase"><a href="single.html">종합 차 세트</a></h2>
                <span class="d-block mb-3">15,900원</span>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="media-image">
              <a href="single.html"><img src="images/product_6.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
                <h2 class="font-secondary text-uppercase"><a href="single.html">벗꽃 차</a></h2>
                <span class="d-block mb-3">6,900원</span>
